...
public class Manage_UserTest {
	...
	//
	// WebElement ClickAddNewUser =
	// wait.until(ExpectedConditions.elementToBeClickable(By.id("btnAddNewUser")));
	...
	// driver.findElement((By.xpath("//div[2]/div/div/div/div[2]/div/span/span/span")));
	// selectagency.click();
	// Thread.sleep(2000);
	//
	...
	// driver.findElements(By.xpath("//ul[@id='Agency_listbox']/li"));
	...
	// driver.findElements(By.xpath("//ul[@id='Role_listbox']/li"));
	// // Loop through the options and select the one that matches
	...
	// wait.until(ExpectedConditions.elementToBeClickable(By.id("CellNo")));
	...
	//
	// WebElement GetText =
	// wait.until(ExpectedConditions.elementToBeClickable(By.className("Success")));
	...
	// Assert.assertEquals(firstnamealertmessage, "The First Name is required
	// field");
	...
	// Assert.assertEquals(lastnamealertmessage1, "The Last Name is required
	// field");
	...
	// wait.until(ExpectedConditions.elementToBeClickable(By.id("FilterKeywords")));
	...
	//
	// WebElement edituserclick =
	// wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='mCSB_2_container']/div[1]/table/tbody/tr/td[2]/a")));
	// edituserclick.click();
	// Thread.sleep(3000);
	//
	// //Edit middle name
	...
	//
	// WebElement edituserclick =
	// wait.until(ExpectedConditions.elementToBeClickable(By.className("grid-link")));
	// edituserclick.click();
	// Thread.sleep(2000);
	//
	// //Edit Email_id
	...
	public void deleteuserwithoutdonor() throws InterruptedException {
		...
		WebElement clickuser = driver.findElement(By.xpath("//*[@id='mCSB_3_container']/div[1]/table/tbody/tr[2]/td[2]/a"));
		clickuser.click();
		Thread.sleep(2000);
